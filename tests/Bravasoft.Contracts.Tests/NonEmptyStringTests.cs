...
{
    private static char First(NonEmptyString s) => ((string)s)[0];
    ...
    [Fact]
    public void NonEmptyIsAcceptedWhereNotNullIsExpected()
    {
        NonEmptyString refined = "hello";
    ...
    {
        NonEmptyString uninitialized = default;
    ...
    {
        Assert.Equal(Unsafe.SizeOf<string>(), Unsafe.SizeOf<NonEmptyString>());
    ...
    {
        NotNull<string> widened = default(NonEmptyString);
